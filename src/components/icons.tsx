...
export function LogoIcon({ className, ...props }: IconProps) {
  return (
    <svg
      ...
      {...props}
    >
      <rect width="24" height="24" rx="6" fill="url(#paint0_linear_101_2)" />
      <path
...
export function LanguageIcon({ className, ...props }: IconProps) {
  return (
    ...
    >
      ...
      <path d="m12 2-2.3 2.3a10 10 0 0 0 0 14.4L12 21" />
      <path d="M12 2a10 10 0 0 1 8 4 10 10 0 0 1 0 12 10 10 0 0 1-8 4" />
    </svg>
  )
}

export function AdminIcon({ className, ...props }: IconProps) {
  return (
    <svg 
      xmlns="http://www.w3.org/2000/svg" 
      viewBox="0 0 24 24" 
    ...
    >
      ...
      <path d="M8.5 8.5a4 4 0 0 0 6.368 3.218" />
      <path d="M14.5 9.5a4 4 0 0 0-6.368-3.218" />
    </svg>
  )
}
